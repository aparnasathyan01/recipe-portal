<?php
  ...
  now())
  ,
  ('Paneer Butter Masala','2.jpg','John Doe','<br/>Ingredients: <br/>½ cup vegetable oil
  ...
  <br/>Recipe: 
  <br/>Step 1: Heat oil in a large skillet over medium heat; 
  ...
  ',now())
  ,
  ('Onigiri Japanese Rice Balls','3.jpg','John Doe','<br/>Ingredients: <br/>4 cups uncooked short-grain white rice, 4 ½ cups water, ¼ teaspoon salt, 
  ¼ cup bonito shavings (dry fish flakes), 2 sheets nori (dry seaweed cut into 1/2-inch strips), 2 tablespoons sesame seeds
  <br/>Recipe: 
  <br/>Step 1: Wash the rice in a mesh strainer until the water runs clear. Combine washed rice and 4 1/2 cups water in a saucepan. Bring to a boil 
  ...
  ,now())
  ,
  ('Plain Cake Doughnuts','4.jpg','John Doe','<br/>Ingredients: <br/>2 cups all-purpose flour, ½ cup white sugar, 1 teaspoon salt, 1 tablespoon baking powder, 
  ...
  <br/>Ingredients: <br/>1 Kg meat, 1 cup mustard/refined oil, 3 tsp red chili powder, 3 tsp fennel powder, 2 tsp ginger powder, 2 tsp cumin powder, 3 tsp brown cardamom powder, 
  ...
  <br/>Recipe: 
  <br/>1.Wash the meat properly. Heat oil in a pressure cooker.
  ...
  <br/>Ingredients: 
  <br/>3 Whole Egg, 1 cup Broccoli florets (chopped into small pieces), 2 Onion (finely chopped), 2 Tomatoes (finely chopped), 6 Garlic cloves (finely chopped), 
  ...
  <br/>Recipe:
  <br/>For marination:-
  <br/>Add all the ingredients for marinating the fish in a bowl and mix well.
